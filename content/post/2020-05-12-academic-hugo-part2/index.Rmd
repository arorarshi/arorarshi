...
I am deploying my site, the one you are reading this post on :), on __Netlify__ and then using a free subdomain with [`rbind.io`](https://github.com/rbind/support_). 
...
* You can change the subdomain and keep the `netlify.app`. Or you can apply for a `rbind.io` domain name.
    + Just open an issue on their [GitHub repository](https://github.com/rbind/support_), and fill their template form. They are quick and will get back to you soon! 
